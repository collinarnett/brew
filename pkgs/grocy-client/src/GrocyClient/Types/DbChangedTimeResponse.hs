...
-- | Contains the types generated from the schema DbChangedTimeResponse
...
-- | Defines the object schema located at @components.schemas.DbChangedTimeResponse@ in the specification.
-- 
-- 
